...
*这个是testing/lich的二进制工具版本（Go请直接使用库版本：github.com/huangbosbos/go-hutool/testing/lich)*
...
```shell
cd github.com/go-strong/strong-gen/tool/testcli
go build -o $GOPATH/bin/testcli
$GOPATH/bin/testcli -h
```
#### Method 3. Import with Strong pkg
```Go
import "github.com/huangbosbos/go-hutool/testing/lich"
```
...
```
#### Method 2. Import with Strong pkg
- Step1. 在 Dao|Service 层中的 TestMain 单测主入口中，import  "github.com/huangbosbos/go-hutool/testing/lich" 引入testcli工具的go库版本。
...
import (
    ...
    "github.com/huangbosbos/go-hutool/conf/paladin"
