...
const (
	toolDoc = "https://github.com/TODOtool.md"
)
...
func toolAction(c *cli.Context) (err error) {
	if c.NArg() == 0 {
		...
		fmt.Println("执行工具: strong tool demo")
		fmt.Println("安装全部工具: strong tool install all")
		fmt.Println("全部升级: strong tool upgrade all")
		fmt.Println("\n详细文档：", toolDoc)
		return
	}
